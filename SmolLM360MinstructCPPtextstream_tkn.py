"""
llama_model_loader: loaded meta data with 37 key-value pairs and 290 tensors from models/SmolLM-360M-Instruct.Q4_M.gguf 
...
llm_load_print_meta: model ftype      = Q4_M
...
modelname = 'SmolLM-360M-Instruct.Q4_K_M.gguf'
logfile = 'SmolLM-360M-Instruct.Q4_K_M_LOG.txt'
