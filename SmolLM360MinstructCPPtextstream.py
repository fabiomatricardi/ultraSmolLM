"""
llama_model_loader: loaded meta data with 37 key-value pairs and 290 tensors from models/SmolLM-360M-Instruct.Q8_0.gguf 
(version GGUF V3 (latest))
llama_model_loader: Dumping metadata keys/values. Note: KV overrides do not apply in this output.
llama_model_loader: - kv   0:                       general.architecture str              = llama
llama_model_loader: - kv   1:                               general.type str              = model
llama_model_loader: - kv   2:                               general.name str              = Cosmo2 350M Webinst Sc2
...
llama_model_loader: - kv   6:                         general.size_label str              = 350M
...
logfile = 'SmolLM-360M-Instruct_LOG.txt'
...
print("\033[95;3;6m")
print("1. Loading the model llama-68m-chat...")
print("2. DONE...")
print("\033[0m")  #reset all
llm = Llama(model_path="models/SmolLM-360M-Instruct.Q8_0.gguf",
            verbose=False,
            n_ctx=2048)
print("\033[92;1m")
counter = 1
